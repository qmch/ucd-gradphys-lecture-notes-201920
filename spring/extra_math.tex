...
\let\curlyre=\Re %rename \Re to \curlyre, in case I ever need it
\renewcommand{\Re}{\operatorname{Re}} %and declare the operator \Re
...
% Add a new command for numbering a single equation in align* environments
